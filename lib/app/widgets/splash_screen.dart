...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _titleSlide = Tween<double>(begin: 20, end: 0).animate(
      CurvedAnimation(parent: _entranceController, curve: const Interval(0.25, 0.7, curve: Curves.easeOut)),
    );
    ...
    _taglineSlide = Tween<double>(begin: 16, end: 0).animate(
      CurvedAnimation(parent: _entranceController, curve: const Interval(0.45, 0.9, curve: Curves.easeOut)),
    );
    ...
    _dot2 = Tween<double>(begin: 0.3, end: 1.0).animate(
      CurvedAnimation(parent: _dotsController, curve: const Interval(0.33, 1.0)),
    );
    _dot3 = Tween<double>(begin: 0.3, end: 1.0).animate(
      CurvedAnimation(parent: _dotsController, curve: const Interval(0.66, 1.0)),
    );
                    ...
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: Opacity(
                          ...
                          child: Transform.scale(
                            scale: 1.0 + (_breatheController.value * 0.04 - 0.02),
