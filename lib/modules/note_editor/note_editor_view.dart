...
class NoteEditorView extends ConsumerWidget {
                          ...
                          child: Row(
                            children: [
                              Text('${controller.wordCount} words',
                                style: GoogleFonts.dmMono(fontSize: 10.5, color: colors.text3)),
                          ...
                          child: QuillEditor.basic(
                            ...
                            config: QuillEditorConfig(
                              ...
                              customStyles: DefaultStyles(
                                ...
                                bold: GoogleFonts.nunito(fontWeight: FontWeight.w800),
                                italic: GoogleFonts.nunito(fontStyle: FontStyle.italic),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              width: 34, height: 34,
              decoration: BoxDecoration(
                color: colors.card2, borderRadius: BorderRadius.circular(10),
              ),
              child: Icon(Icons.arrow_back_ios_new, size: 14, color: colors.text2),
            ),
          ),
          const SizedBox(width: 8),
  ...
  Widget _buildTagPills(dynamic colors, NoteEditorController controller) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('TAG', style: GoogleFonts.dmMono(
            fontSize: 10.5, fontWeight: FontWeight.w700,
            color: colors.text3, letterSpacing: 0.7,
          )),
          const SizedBox(height: 8),
          Wrap(
            spacing: 8,
            children: [
              _tagPill('Work', colors.tagWorkBg, colors.tagWork, colors, controller),
              _tagPill('Personal', colors.tagPersonalBg, colors.tagPersonal, colors, controller),
              _tagPill('Ideas', colors.tagIdeasBg, colors.tagIdeas, colors, controller),
              _tagPill('', colors.card2, colors.text3, colors, controller, label: 'None'),
  ...
  Widget _tagPill(String tag, Color bg, Color fg, dynamic colors, NoteEditorController controller, {String? label}) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Text(label ?? tag, style: GoogleFonts.nunito(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('Custom', style: GoogleFonts.nunito(
              fontSize: 12.5, fontWeight: FontWeight.w700, color: colors.text3)),
          ],
        ),
      ),
    );
  ...
  void _showCreateTagDialog(dynamic colors, NoteEditorController controller) {
    ...
    Get.dialog(
      AlertDialog(
        ...
        title: Text('Create tag', style: GoogleFonts.nunito(
        ...
        actions: [
          TextButton(
            ...
            child: Text('Cancel', style: GoogleFonts.nunito(
              fontSize: 14, fontWeight: FontWeight.w700, color: colors.text3)),
          ),
          TextButton(
            onPressed: () {
            ...
            child: Text('Add', style: GoogleFonts.nunito(
              fontSize: 14, fontWeight: FontWeight.w700, color: colors.accent)),
          ),
        ],
      ),
    );
