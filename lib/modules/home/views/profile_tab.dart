    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _FacebookProfileHeader(controller: controller, colors: colors, ref: ref),
          ...
          _SettingsCard(colors: colors, children: [
            ...
            _SettingsRow(
                ...
                iconBg: colors.tagIdeasBg,
                iconColor: colors.tagIdeas,
                onTap: () => Get.snackbar('📤', 'Backup complete!',
...
class _FacebookProfileHeader extends StatelessWidget {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: AppColors.avatarColors[controller.avatarColorIndex %
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.dmMono(
                          fontSize: 12.5, color: colors.text3),
                    ),
  ...
  void _showAvatarPicker(
      BuildContext context, WidgetRef ref, HomeController controller, dynamic colors) {
    Get.bottomSheet(
      Container(
            ...
            _PickerTile(
              ...
              onTap: () async {
                ...
                try {
                  ...
                  Get.snackbar('Permission denied', 'Could not access your photos',
                      snackPosition: SnackPosition.TOP);
                }
              },
            ),
            ...
            _PickerTile(
              ...
              onTap: () async {
                ...
                try {
                  ...
                  Get.snackbar('Permission denied', 'Could not access your camera',
                      snackPosition: SnackPosition.TOP);
                }
              },
            ),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(sub,
                    style: GoogleFonts.dmMono(
                        fontSize: 11.5, color: colors.text3)),
              ],
            ),
          ],
        ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (!isDestructive) Icon(Icons.chevron_right, size: 20, color: colors.text3),
          ],
        ),
      ),
    );
