          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.lock_outline_rounded, color: colors.accent, size: 26),
              ),
              const SizedBox(height: 18),
              ...
              Text('EMAIL ADDRESS', style: GoogleFonts.dmMono(
                fontSize: 11, fontWeight: FontWeight.w700, color: colors.text3,
                letterSpacing: 0.7,
              )),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: controller.forgotEmailError.isEmpty
                      ? null : controller.forgotEmailError,
                ),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: controller.forgotLoading
                      ...
                      : Text('Send reset link', style: GoogleFonts.nunito(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 6),
                      Text('Check your inbox!', style: GoogleFonts.nunito(
                        fontSize: 14, fontWeight: FontWeight.w700, color: colors.tagIdeas,
                      )),
                      const SizedBox(height: 4),
                      Text('We sent a reset link to your email', style: GoogleFonts.nunito(
                        fontSize: 12.5, color: colors.text2,
                      )),
                    ],
                  ),
                ),
              ...
              Center(
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text('Remember your password? ', style: GoogleFonts.nunito(
