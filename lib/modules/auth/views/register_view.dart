...
class RegisterView extends ConsumerWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Back', style: GoogleFonts.nunito(
                      fontSize: 14, fontWeight: FontWeight.w700, color: colors.text2,
                    )),
                  ],
                ),
              ),
              ...
              Text('Create account', style: GoogleFonts.nunito(
                fontSize: 24, fontWeight: FontWeight.w800, color: colors.text,
                letterSpacing: -0.3,
              )),
              const SizedBox(height: 5),
              Text('Join Chitpad and start writing', style: GoogleFonts.nunito(
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: controller.regUsernameError.isEmpty
                      ? null : controller.regUsernameError,
                ),
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: controller.regPasswordError.isEmpty
                      ? null : controller.regPasswordError,
              ...
              Builder(builder: (_) {
                ...
                Color barColor;
                switch (strength) {
                  case 1: barColor = colors.danger; break;
                  case 2: barColor = colors.star; break;
                  case 3: barColor = const Color(0xFFF59E0B); break;
                  case 4: barColor = colors.tagIdeas; break;
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.dmMono(
                        fontSize: 11, color: strength > 0 ? barColor : colors.text3,
                      ),
                    ),
                  ],
                );
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('or', style: GoogleFonts.dmMono(
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text('Continue with Google', style: GoogleFonts.nunito(
  ...
  Widget _label(String text, Color color) {
    return Text(text, style: GoogleFonts.dmMono(
      fontSize: 11, fontWeight: FontWeight.w700, color: color, letterSpacing: 0.7,
    ));
  }
}
