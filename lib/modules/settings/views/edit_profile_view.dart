...
class EditProfileView extends ConsumerWidget {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: AppColors.coverGradients[
                              controller.coverGradientIndex %
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () =>
                                  _showCoverColorPicker(context, controller, colors),
                              child: Container(
                          ...
                          Positioned(
                            ...
                            child: Center(
                              child: GestureDetector(
                                onTap: () =>
                                    _showAvatarPicker(context, controller, colors),
                                child: Container(
                                  width: 72,
                                  height: 72,
                                  decoration: BoxDecoration(
                                    ...
                                    color: AppColors.avatarColors[
                                        controller.avatarColorIndex %
                                            AppColors.avatarColors.length],
                                    border:
                                        Border.all(color: colors.bg, width: 3),
                                    boxShadow: [
                                      BoxShadow(
                                        color: Colors.black
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          _field('DISPLAY NAME', controller.displayNameCtrl, colors),
                          _field('USERNAME', controller.usernameCtrl, colors),
                          _field('EMAIL', controller.emailCtrl, colors,
  ...
  void _showAvatarPicker(
      BuildContext context, SettingsController controller, dynamic colors) {
    Get.bottomSheet(
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Choose a solid color for your avatar',
          ...
          children: [
            Text('Cover color',
                style: GoogleFonts.nunito(
                    fontSize: 17, fontWeight: FontWeight.w800, color: colors.text)),
            const SizedBox(height: 4),
            Text('Pick a solid color for your cover',
                style: GoogleFonts.dmMono(fontSize: 12, color: colors.text3)),
            const SizedBox(height: 16),
            Wrap(
              spacing: 12,
            ...
            Wrap(
              ...
              children: List.generate(AppColors.coverGradients.length, (i) {
                final isSelected = controller.coverGradientIndex ==
                    coverColors.length + i;
                return GestureDetector(
                  onTap: () {
  ...
  Widget _field(String label, TextEditingController textController, dynamic colors,
  ...
  Widget _textArea(String label, TextEditingController textController,
      dynamic colors) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 14),
      child: Column(
