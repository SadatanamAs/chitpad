...
class AppearanceView extends ConsumerWidget {
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text('THEME', style: GoogleFonts.dmMono(
                      fontSize: 10.5, fontWeight: FontWeight.w700, color: colors.text3, letterSpacing: 0.7)),
                    ...
                    Text('FONT SIZE', style: GoogleFonts.dmMono(
                      fontSize: 10.5, fontWeight: FontWeight.w700, color: colors.text3, letterSpacing: 0.7)),
                    const SizedBox(height: 10),
  ...
  Widget _fontRow(String label, String sizeId, double fontSize, dynamic colors, ThemeController tc) {
          ...
          children: [
            Expanded(
              child: Text(label, style: GoogleFonts.nunito(
                fontSize: fontSize, fontWeight: FontWeight.w700, color: colors.text,
              )),
            ),
            if (isSelected)
