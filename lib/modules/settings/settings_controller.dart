...
class SettingsController extends ChangeNotifier {
  ...
  void _init() {
    ...
    displayNameCtrl.addListener(() { displayName = displayNameCtrl.text; notifyListeners(); });
    usernameCtrl.addListener(() { username = usernameCtrl.text; notifyListeners(); });
    emailCtrl.addListener(() { email = emailCtrl.text; notifyListeners(); });
    bioCtrl.addListener(() { bio = bioCtrl.text; notifyListeners(); });
  }
